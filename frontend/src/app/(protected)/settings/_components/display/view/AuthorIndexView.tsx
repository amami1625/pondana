...
import { useSettingAuthor } from '@/app/(protected)/settings/_hooks/useSettingAuthor';
...
interface AuthorindexViewProps {
  authors: Author[];
}

export default function AuthorindexView({ authors }: AuthorindexViewProps) {
  const { editingAuthor, handleEdit, handleCreate, handleDelete, createModal, editModal } =
    useSettingAuthor();
