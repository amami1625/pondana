...
| カテゴリ           | 技術                    | 説明・用途                                       |
| ------------------ | ----------------------- | ------------------------------------------------ |
| **フロントエンド** | Next.js 16              | React フレームワーク                             |
|                    | TypeScript              | 型安全な JavaScript                              |
|                    | TailwindCSS             | ユーティリティファースト CSS フレームワーク      |
| **バックエンド**   | Ruby on Rails 7.2       | Web アプリケーションフレームワーク               |
| **データベース**   | PostgreSQL (Neon)       | リレーショナルデータベース                       |
| **認証**           | Supabase Authentication | 認証サービス                                     |
| **インフラ**       | Docker                  | コンテナ基盤                                     |
|                    | Docker Compose          | コンテナオーケストレーション                     |
| **デプロイ**       | Vercel                  | フロントエンドホスティング                       |
|                    | Render                  | バックエンドホスティング                         |
| **状態管理**       | TanStack Query          | データフェッチ・キャッシュ管理・サーバー状態管理 |
| **フォーム**       | React Hook Form         | 高性能なフォーム管理                             |
|                    | Zod                     | 型安全なスキーマバリデーション                   |
| **画像管理**       | Next Cloudinary         | Cloudinary 連携による画像アップロード・最適化    |
| **UI/UX**          | react-hot-toast         | トースト通知                                     |
| **テスト**         | vitest                  | フロントエンド単体テストフレームワーク           |
|                    | React Testing Library   | React コンポーネントテスト                       |
|                    | Playwright              | E2E テスト（エンドツーエンドテスト）             |
|                    | MSW                     | API モッキング（テスト用）                       |
|                    | RSpec                   | Rails テストフレームワーク                       |
| **コード品質**     | rubocop                 | Ruby コード静的解析                              |
