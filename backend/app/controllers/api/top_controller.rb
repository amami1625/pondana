module Api
  class TopController < Api::ApplicationController
    def index
      # 最新の本（5件）
      ...
      render json: {
        recent_books: recent_books.as_json(include: %i[category tags]),
        recent_lists: recent_lists,
        recent_cards: recent_cards.as_json(include: %i[book status])
      }
    end
  end
end
